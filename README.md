...
<h1></h1>
<li>Если вылезла какая-либо ошибка(включая "Вылезла капча" откройте сайт варфейса, подождите минуту и запускайте start.bat. Если это не помогло, то напишите мне на фанпее или создайте новый вопрос по ссылке https://github.com/Rustamom/warfacePinsActivation/issues/new</li>
...
Откройте сайт <strong>ru.warface.com</strong> и подождите секунд 10-20(С версии 1.3.0 этого делать не нужно)<br>
...
ПОПОЛНЯЕТЕ БАЛАНС(5 рублей будет достаточно для активации 500 пинкодов)и копируете ключ с главной страницы<br>
