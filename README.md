...
<h1>На данный момент работает только ручной ввод куки</h1>
<li>Если вылезла какая-либо ошибка откройте сайт варфейса, подождите минуту и запускайте start.bat. Если это не помогло, то напишите мне на фанпее или создайте новый вопрос по ссылке https://github.com/Rustamom/warfacePinsActivation/issues/new</li>
